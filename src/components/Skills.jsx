            ...
            <div className="flex flex-col w-full 2xl:w-2/3">
                ...
                {isFirstTitleAnimationComplete && (
                    <>
                        ...
                        {isSecondTitleAnimationComplete && (
                            <div ref={langagesRef} className="opacity-0 bg-green-800 bg-opacity-80 rounded-lg grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-8 sm:px-0">
                ...
                {isSecondTitleAnimationComplete && (
                    <>
                        ...
                        {isThirdTitleAnimationComplete && (
                            <div ref={osRef} className="opacity-0 bg-green-800 bg-opacity-80 rounded-lg grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-8 sm:px-0">
                ...
                {isThirdTitleAnimationComplete && (
                    <>
                        ...
                        {isFourthTitleAnimationComplete && (
                            <div ref={toolsRef} className="opacity-0 bg-green-800 bg-opacity-80 rounded-lg grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-8 sm:px-0">
