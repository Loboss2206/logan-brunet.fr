            ...
            <div className="flex flex-col w-full 2xl:w-2/3">
                ...
                {isFirstTitleAnimationComplete && (
                    <>
                        ...
                        {isSecondTitleAnimationComplete && (
                            <div ref={langagesRef} className="opacity-0 bg-gray-900/90 dark:bg-gray-800/80 shadow-lg shadow-gray-900/80 dark:shadow-white/50 rounded-lg grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-7 gap-8 sm:px-0 p-4 mt-4">
                ...
                {isSecondTitleAnimationComplete && (
                    <>
                        ...
                        {isThirdTitleAnimationComplete && (
                            <div ref={osRef} className="opacity-0 bg-gray-900/90 dark:bg-gray-800/80 shadow-lg shadow-gray-900/80 dark:shadow-white/50 rounded-lg grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-7 gap-8 sm:px-0 p-4 mt-4">
                ...
                {isThirdTitleAnimationComplete && (
                    <>
                        ...
                        {isFourthTitleAnimationComplete && (
                            <div ref={toolsRef} className="opacity-0 bg-gray-900/90 dark:bg-gray-800/80 shadow-lg shadow-gray-900/80 dark:shadow-white/50 rounded-lg grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-7 gap-8 sm:px-0 p-4 mt-4">
