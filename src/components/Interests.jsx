    ...
    return (
        ...
        >
            <div className="flex flex-col w-full 2xl:w-2/3">
                <CustomTitle title='find -name "*interests*"' margin="12"
                ...
                <div ref={interestsRef} className="opacity-0 p-4 mt-4">
                    <div className="hidden md:flex items-center inline relative">
                        ...
                        <div className='mx-auto flex flex-col justify-end h-96 px-4'>
                            <a href="https://www.japan.travel/" target="_blank" rel="noreferrer">
                    ...
                    <div
                        className="md:hidden flex flex-col bg-gray-900/90 dark:bg-gray-800/80 shadow-lg shadow-gray-900/80 dark:shadow-white/50 rounded-lg p-2">
                        <InterestBox title="Volley-ball" description="I play volley-ball every weeks." srcImage={ball}
                                     link="http://www.ffvb.org/"/>
                        <InterestBox title="Travelling" description="I love travelling and discovering new places."
                                     srcImage={plane} link="https://www.lonelyplanet.com/"/>
                        <InterestBox title="Japan" description="I love so much manga and food from Japan." srcImage={narutomaki}
